...
<head>
    ...
    <title>{{ config('app.name', 'ISIburger') }}</title>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item active relative">
                        <a class="nav-link" href="{{ url('home') }}">
                            <div class="flex" id="navbtnhome" aria-describedby="tooltiphome" data-tooltip-text="Accueil">
                    ...
                    <li class="nav-item active relative">
                        <a class="nav-link" href="{{ url('order') }}">
                            <div class="flex" id="navbtnorderhistory" aria-describedby="tooltiporderhistory" data-tooltip-text="Historique des commandes">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <li class="nav-item active relative ">
                        <a class="nav-link" href="{{ url('cart') }}">
                            <div class="flex" id="navbtncart" aria-describedby="tooltipcart" data-tooltip-text="Panier">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <li class="nav-item active relative">
                        <a class="nav-link" href="{{ url('food/viewfood') }}">
                            <div class="flex" id="navbtnviewfood" aria-describedby="tooltipviewfood" data-tooltip-text="Voir les aliments">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ url('user/edit') }}">
                                {{ __('Paramètres utilisateur') }}
                            </a>
                            <a id="deleteuser" class="dropdown-item" href="#">
                                {{ __('Supprimer le compte utilisateur') }}
                            </a>
                ...
                <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="p-1 sm:flex sm:items-start">
                            ...
                            <div class="pl-1 sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Êtes-vous sûr de vouloir supprimer le compte ?</h3>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <form name="remove_user_form" id="remove_user_form" method="POST" action='/user/{{Auth::id()}}'>
                            @csrf
                            @method('delete')
                            <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm"> Confirmer </button>
                        </form>
