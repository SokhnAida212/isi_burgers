<?php
// Initialiser le tableau du panier dans la session
...
<div class="mx-8">
    <div class="flex flex-row">
        <div class="flex flex-row space-x-4 flex-grow">
            <span class="font-weight-bold sort-font my-auto">Filtrer Par :</span>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="/home" class="sort-font">Tous</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/poulet" class="sort-font">Poulet</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/bœuf" class="sort-font">Bœuf</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/végétarien" class="sort-font">Végétarien</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/Poisson" class="sort-font">Poisson</a>
            </div>
        </div>
        <div class="flex flex-row space-x-4 flex-grow justify-end">
            <span class="font-weight-bold sort-font my-auto">Trier Par :</span>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="{{url()->current().'?asc=true'}}" class="sort-font">Prix croissant</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="{{url()->current().'?asc=false'}}" class="sort-font">Prix décroissant</a>
            </div>
        </div>
    </div>
</div>
...
<div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-5">
    ...
    <div class="rounded-md overflow-hidden shadow-md border-1 border-gray-100">
        <a href="../food/{{$data['id']}}">
            <img class="h-48 w-full object-cover" src="{{ asset($data['picture']) }}" alt="{{ $data['name'] }}">
            <div class="p-4">
