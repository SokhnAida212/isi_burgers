...
<div class="flex flex-col items-center">
    <div class="flex flex-col items-center w-4/5">
        <div class="self-end pb-2">
            ...
            font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Ajouter <i class="material-icons self-center">add</i></button>
        </div>
        <table class="p-10 border-collapse border bg-white">
            ...
            <tr>
                ...
                <th class="border px-2 py-2">Prix</th>
            ...
            <tr>
                ...
                <td class="border px-2 py-2">
                    ...
                    <form action="/updatefood/{{$food['id']}}" method="GET">
                        @csrf
                        <button type="submit" class="text-sky-600">Modifier</button>
                    </form>
                    @endcan
                </td>
                <td class="border px-2 py-2">
