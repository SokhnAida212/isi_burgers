...
<h1 class="px-4 pt-1 pb-3 text-3xl font-bold">
    <div class="flex flex-row flex-1">
        <span class="mr-5 self-center"> Mon historique de commandes </span>
...
<div class="px-3 py-2">
    <div class="flex flex-row p-4 leading-normal border shadow-md hover:bg-gray-100">
        <div class="p-2 w-1/5">
            <p class="mb-1"> ID de commande : <span class="font-semibold"> {{$order->id}} </span> </p>
            <p class="mb-1"> Date : <span class="font-semibold">  {{ \Carbon\Carbon::parse($order->date)->translatedFormat('j F Y') }} </span> </p>
            <p class="mb-1"> Type : <span class="font-semibold capitalize"> {{$order->type}} </span> </p>
            <p class="mb-1"> Total : <span class="font-semibold capitalize"> {{$order->total}} FCFA</span> </p>
            <div class="mt-2">
            ...
            <div class="flex flex-col justify-between">
                ...
                <div class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100">
                    ...
                    <div class="flex flex-col place-content-center px-4 py-3 leading-normal w-4/6">
                        ...
                        <p class="flex font-normal text-gray-700"> Quantité : <b>&nbsp;{{$food->pivot->quantity}}</b> </p>
                        <p class="flex font-normal text-gray-700"> Prix : <b>&nbsp;{{ (int) $food->price*$food->pivot->quantity}} FCFA&ensp;</b> <span class="opacity-60"> [{{(int) $food->price}}FCFA l'unité] <span> </p>
                    </div>
                </div>
                <div class="p-1"></div>
                @endforeach
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="p-1 sm:flex sm:items-start">
                    ...
                    <div class="pl-1 sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Êtes-vous sûr de vouloir supprimer cette commande de votre historique ?</h3>
                    </div>
                </div>
            </div>
