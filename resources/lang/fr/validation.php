...
return [
    ...
    | versions, comme les règles de taille. N'hésitez pas à ajuster ces messages.
    |
    */
    ...
    'regex' => 'Le format du champ :attribute est invalide. Le mot de passe doit contenir au moins 1 majuscule (A-Z), 1 minuscule (a-z), 1 chiffre (0-9), et 1 caractère non alphanumérique (!, $, #, ou %).',
    ...
    | lignes. Cela permet de spécifier rapidement un message personnalisé pour
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer les
    | placeholders d'attribut par quelque chose de plus convivial, comme
    | "Adresse e-mail" au lieu de "email". Cela nous aide à rendre nos
    | messages plus expressifs.
    |
    */
